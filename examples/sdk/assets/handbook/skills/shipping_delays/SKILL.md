...
description: What to promise a customer whose parcel is late
...
- **Delivered but not received** - open a carrier investigation first. It takes
  up to 5 working days; do not promise money before it closes.
